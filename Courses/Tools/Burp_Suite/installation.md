...
Open the .jar file downloaded previously.

```bash
java -jar </path/to/burpsuite.jar>
```

There is a screenshot of the (professional) Burp Suite welcome page. 

![welcome](https://github.com/ftTower/ftTower/blob/main/assets/Cybersec-Portfolio/Courses/Tools/burp_suite/default_professional.png)
