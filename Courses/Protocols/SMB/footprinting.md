...
```
>not very efficiant with SMB

---

### RPC Client

rpcclient is a tool used to interact with smb server and gather information about itself.
...
[more query commands](https://www.samba.org/samba/docs/current/man-html/rpcclient.1.html)
...
>it can also happen that not all commands are available to us, and we have certain restrictions based on the user. However, the query queryuser <RID> is mostly allowed based on the RID

#### Brute Forcing User RIDs

So we can use the rpcclient to brute force the RIDs to get information.
...
Samrdump from Impacket is a python script alternative to Rpcclient 
