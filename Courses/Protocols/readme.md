...
### 1. SSH - Secure Shell
- **Main:** [SSH Protocol](./SSH/)
- [Configuration and setup](./SSH/configuration.md)
- [Footprinting](./SSH/footprinting.md)

### 2. SMB - Server Message Block
- **Main:** [SMB Protocol](./SMB/)
- [Configuration and setup](./SMB/configuration.md)
- [Footprinting](./SMB/footprinting.md)

### 3. MSSQL - Microsoft SQL
- **Main:** [MSSQL Protocol](./MSSQL/)
- [Configuration and setup](./MSSQL/configuration.md)
- [Footprinting](./MSSQL/footprinting.md)
